...
public class IncomeService {
    ...
    public void deleteIncome(Long incomeId) {
        ...
        if(!entity.getProfile().getId().equals(profile.getId())) {
            throw new RuntimeException("Unable to delete income");
        }
